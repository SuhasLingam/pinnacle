    ...
    <main className="min-h-screen bg-transparent text-white overflow-hidden">
        ...
        >
          ...
          <h1 className="mb-6 sm:mb-8 overflow-hidden">
            <div
              ...
              style={{ gap: "clamp(0.5rem, 2vw, 2.5rem)" }}
            >
          ...
          >
            <div
              className="flex justify-center flex-wrap"
              style={{ gap: "clamp(0.25rem, 1vw, 1.5rem)" }}
            >
              {/* 1ST */}
              {["1", "S", "T"].map((letter, i) => (
                <motion.span
          ...
          <ApplyButton slug="tic-pinnacle-hacks-2025" theme="light" />
      ...
      >
        <h2 className="text-3xl sm:text-5xl  font-mono-rubik mb-10 sm:mb-12 text-center tracking-[0.3em] flex justify-center gap-2 sm:gap-4">
          <span className="animated-gradient">ABOUT</span>
        </h2>
        <About />
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div className="space-y-4">
              <h3 className="text-[#B4FF00] font-bold text-xl tracking-wider">
                PINNACLE
              </h3>
              <p className="text-white/70 text-sm leading-relaxed">
                Join us in this exciting journey of innovation, learning, and
                growth at Pinnacle Hackathon.
              </p>
